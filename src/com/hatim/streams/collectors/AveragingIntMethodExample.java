...
public class AveragingIntMethodExample {
    ...
    public static void main(String[] args) {
        ...
        // 1. Average salary
        double result1 =  employee.stream().collect(Collectors.averagingInt(Employee::getSalary));
        System.out.println(result1);

        // 2. Average employee age
        double result2 = employee.stream().collect(Collectors.averagingInt(Employee::getAge));
